;;; -*- Emacs-Lisp -*- ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; $Id: bsv-mode.el 10408 2007-03-16 19:02:09Z baltus $
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;  (make-local-hook 'after-change-functions)
  ...
  (get-font-lock-keywords)
  (set (make-local-variable 'font-lock-defaults)
       '(bsv-font-lock-keywords
	 nil nil ((?_ . "w")) nil
...
(defun bsv-add-header ()
  (interactive)
    (goto-char (point-min))
    (insert "////////////////////////////////////////////////////////////////////////////////\n")
    (insert "///\n")
    (insert
     (format "/// (c) Copyright %s, Bluespec Incorporated and %s.\n"
	     (bsv-current-year-string)
	     (special-user-full-name)))
    (insert "///\n")
    (insert "/// Time-stamp: <>\n")
    (insert "///\n")
    (insert "/// $Id: ")
...
(defvar bsv-font-lock-keywords bsv-font-lock-keywords-3
